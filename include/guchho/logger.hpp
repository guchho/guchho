...
namespace guchho::logger {
    ...
    enum class MsgCat : uint16_t {
        ...
        // -------------------------------------------------------------------
        kResolverDebug_CheckingForPackageAliasMatches,
        kResolverDebug_MatchedWithAliasFromTo,
        kResolverDebug_ModifiedImportPathFromTo,
        kResolverDebug_ChangedResolveDirectoryTo,
        kResolverDebug_FailedToFindAnyPackageAliasMatches,
        kResolverDebug_ThePathWasMarkedAsExternalByTheUser,
        kResolverDebug_MarkingThisPathAsImplicitlyExternal,
        kResolverDebug_PuttingThisPathInTheDataurlNamespace,
        kResolverDebug_MarkingThisDataURLAsExternal,
        kResolverDebug_CannotResolveThisPathWithoutADirectory,
        kResolverDebug_CannotResolveAPathContainingAWildcardCharacterInASinglePathContext,
        kResolverDebug_InvalidGoRegularExpressionForIgnorePatternData,
        kResolverDebug_RetryingResolutionAfterRemovingTheSuffix,
        kResolverDebug_IgnoringEmptyGlobPattern,
        kResolverDebug_IgnoringGlobImportThatDoesnTStartWithOr,
        kResolverDebug_FailedToFindTheDirectory,
        kResolverDebug_ConsideringEntry,
        kResolverDebug_CheckingAgainstTheExternalPattern,
        kResolverDebug_ResolvedSymlinkTo,
        kResolverDebug_MarkingThisFileAsHavingNoSideEffectsDueTo,
        kResolverDebug_ThisImportIsUnderTheEffectOf,
        kResolverDebug_JsxFactoryIsDueTo,
        kResolverDebug_JsxFragmentIsDueTo,
        kResolverDebug_PrimaryPathIsInNamespace,
        kResolverDebug_SecondaryPathIsInNamespace,
        kResolverDebug_TheImportIsBeingTreatedAsAnAbsolutePath,
        kResolverDebug_FailedToReadDirectory,
        kResolverDebug_ReadForDirectory,
        kResolverDebug_FailedToReadFile,
        kResolverDebug_TheFileExists,
        kResolverDebug_TheYarnPnPPathResolutionAlgorithmReturnedAnError,
        kResolverDebug_ParsedTsconfigPackageNameAndPackageSubpath,
        kResolverDebug_LookingForInExportsMapIn,
        kResolverDebug_FailedToReadDirectory2,
        kResolverDebug_AttemptingToLoadAsAFile,
        kResolverDebug_CheckingForFile,
        kResolverDebug_FoundFile,
        kResolverDebug_FailedToFindFile,
        kResolverDebug_AttemptingToLoadAsADirectory,
        kResolverDebug_FoundMainFieldWithPath,
        kResolverDebug_SearchingForMainFieldsIn,
        kResolverDebug_DidNotFindMainField,
        kResolverDebug_ResolvedToUsingTheModuleFieldIn,
        kResolverDebug_TheFallbackPathInCaseOfRequireIs,
        kResolverDebug_ResolvedToBecauseOfRequire,
        kResolverDebug_ResolvedToUsingTheFieldIn,
        kResolverDebug_MatchingAgainstPathsIn,
        kResolverDebug_UsingAsBaseUrl,
        kResolverDebug_FoundAnExactMatchForInPaths,
        kResolverDebug_IgnoringSubstitutionBecauseItEndsInDTs,
        kResolverDebug_FoundAFuzzyMatchForInPaths,
        kResolverDebug_MarkingThisPathAsImplicitlyExternalDueToItBeingANodeBuiltIn,
        kResolverDebug_MarkingThisPathAsImplicitlyExternalDueToTheNodePrefix,
        kResolverDebug_RemovingTheNodePrefixBecauseTheTargetEnvironmentDoesnTSupportItWithImportStatements,
        kResolverDebug_RemovingTheNodePrefixBecauseTheTargetEnvironmentDoesnTSupportItWithRequireCalls,
        kResolverDebug_SearchingForInNodeModulesDirectoriesStartingFrom,
        kResolverDebug_MarkingThisPathAsExternalBecauseItSAPackagePath,
        kResolverDebug_FailedToResolveToAFile,
        kResolverDebug_ParsedPackageNameAndPackageSubpath,
        kResolverDebug_CheckingForAPackageInTheDirectory,
        kResolverDebug_NoBrowserMapFoundInDirectory,
        kResolverDebug_CheckingForInTheBrowserMapIn,
        kResolverDebug_CheckingFor,
        kResolverDebug_FoundMarkedAsDisabled,
        kResolverDebug_FoundMappingTo,
        kResolverDebug_FailedToFind,
        kResolverDebug_LookingForInImportsMapIn,
        kResolverDebug_ThePathMustNotEqual,
        kResolverDebug_TheResolvedPathIsExact,
        kResolverDebug_ResolvedTo,
        kResolverDebug_TheImportIsMissingTheExtension,
        kResolverDebug_ThePathIsADirectoryWhichIsNotAllowed,
        kResolverDebug_TheImportIsMissingTheSuffix,
        kResolverDebug_TheResolvedPathIsInexact,
        kResolverDebug_ThePathContainsInvalidURLEscapes,
        kResolverDebug_ThePathIsNotAllowedToContain,
        kResolverDebug_ThePathIsNotAllowedToEndWithASlash,
        kResolverDebug_ThePackageImportIsNotDefined,
        kResolverDebug_InvalidPackageConfiguration,
        kResolverDebug_UsingTheEntryFor,
        kResolverDebug_ThePathIsNotExported,
        kResolverDebug_CheckingObjectPathMapFor,
        kResolverDebug_FoundExactMatchFor,
        kResolverDebug_TheKeyMatchedWithLeftOver,
        kResolverDebug_TheKeyDidNotMatch,
        kResolverDebug_NoKeysMatched,
        kResolverDebug_CheckingPathAgainstTarget,
        kResolverDebug_CheckingConditionMapForOneOf,
        kResolverDebug_TheKeyApplies,
        kResolverDebug_TheKeyDoesNotApply,
        ...
        kResolverDebug_SubstitutedForInToGet,
        kResolverDebug_JoinedToToGet,
        kResolverDebug_TheTargetIsInvalidBecauseItDoesnTStartWith,
        kResolverDebug_TheTargetIsInvalidBecauseItContainsInvalidSegment,
        kResolverDebug_ThePathIsInvalidBecauseItContainsInvalidSegment,
        kResolverDebug_UsingYarnPnPManifestFrom,
        kResolverDebug_ResolvingIn,
        kResolverDebug_FailedToParseSpecifierIntoABareIdentifier,
        kResolverDebug_ParsedBareIdentifierAndModulePath,
        kResolverDebug_FoundParentLocator,
        kResolverDebug_FoundParentPackageAt,
        kResolverDebug_FailedToFindInPackageDependenciesOfParentPackage,
        kResolverDebug_SearchingForAFallbackBecauseEnableTopLevelFallbackIsTrue,
        kResolverDebug_StoppingBecauseIsInFallbackExclusionList,
        kResolverDebug_FoundDependencyLocator,
        kResolverDebug_FoundPackageAt,
        kResolverDebug_ResolvedViaYarnPnPToWithSubpath,
        kResolverDebug_IgnoringBecauseItMatchesIgnorePatternData,
        kResolverDebug_FoundFallbackForInPackageDependenciesOfTopLevelPackage,
        kResolverDebug_FoundFallbackForInFallbackPool,
        kResolverDebug_FailedToFindFallbackForInFallbackPool,
        kResolverDebug_YarnPnPInvariantViolationGETPACKAGEFailedToFindAPackage,
        kResolverDebug_ExtractedJSONDataFrom,
