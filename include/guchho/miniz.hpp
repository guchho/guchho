#pragma once
// Vendored miniz 3.1.2 (https://github.com/richgel999/miniz) - public domain / MIT
// See src/core/filesystem/miniz/LICENSE.txt and README.md
// This header is the public API portion of the amalgamated miniz.c (lines 1-1896).
// It respects MINIZ_NO_* macros when defined before inclusion (as in fs_zip.cpp).
...
#define MZ_READ_LE16(p)                                                        \
  ((mz_uint32)((reinterpret_cast<const mz_uint8 *>(p))[0]) |                  \
   ((mz_uint32)((reinterpret_cast<const mz_uint8 *>(p))[1]) << 8U))
#define MZ_READ_LE32(p)                                                        \
  ((mz_uint32)((reinterpret_cast<const mz_uint8 *>(p))[0]) |                  \
   ((mz_uint32)((reinterpret_cast<const mz_uint8 *>(p))[1]) << 8U) |          \
   ((mz_uint32)((reinterpret_cast<const mz_uint8 *>(p))[2]) << 16U) |         \
   ((mz_uint32)((reinterpret_cast<const mz_uint8 *>(p))[3]) << 24U))
#endif

#define MZ_READ_LE64(p)                                                        \
  ((static_cast<mz_uint64>(MZ_READ_LE32(p))) |                                 \
   ((static_cast<mz_uint64>(MZ_READ_LE32(reinterpret_cast<const mz_uint8 *>(p) + sizeof(mz_uint32)))) \
    << 32U))
...
enum {
  ...
  TDEFL_OUT_BUF_SIZE = static_cast<mz_uint>((TDEFL_LZ_CODE_BUF_SIZE * 13) / 10),
  TDEFL_MAX_HUFF_SYMBOLS = 288,
