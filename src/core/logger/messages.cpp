...
namespace guchho::logger {
    ...
    std::string_view MsgTemplate(MsgCat id)
    {
        ...
        // -------------------------------------------------------------------
        // Resolver debug notes (resolver.cpp / package_json.cpp / yarnpnp.cpp)
        // -------------------------------------------------------------------
        case MsgCat::kResolverDebug_CheckingForPackageAliasMatches: return "Checking for package alias matches";
        case MsgCat::kResolverDebug_MatchedWithAliasFromTo: return "  Matched with alias from {} to {}";
        case MsgCat::kResolverDebug_ModifiedImportPathFromTo: return "  Modified import path from {} to {}";
        case MsgCat::kResolverDebug_ChangedResolveDirectoryTo: return "  Changed resolve directory to {}";
        case MsgCat::kResolverDebug_FailedToFindAnyPackageAliasMatches: return "  Failed to find any package alias matches";
        case MsgCat::kResolverDebug_ThePathWasMarkedAsExternalByTheUser: return "The path {} was marked as external by the user";
        case MsgCat::kResolverDebug_MarkingThisPathAsImplicitlyExternal: return "Marking this path as implicitly external";
        case MsgCat::kResolverDebug_PuttingThisPathInTheDataurlNamespace: return "Putting this path in the \"dataurl\" namespace";
        case MsgCat::kResolverDebug_MarkingThisDataURLAsExternal: return "Marking this data URL as external";
        case MsgCat::kResolverDebug_CannotResolveThisPathWithoutADirectory: return "Cannot resolve this path without a directory";
        case MsgCat::kResolverDebug_CannotResolveAPathContainingAWildcardCharacterInASinglePathContext: return "Cannot resolve a path containing a wildcard character in a single-path context";
        case MsgCat::kResolverDebug_InvalidGoRegularExpressionForIgnorePatternData: return "  Invalid Go regular expression for \"ignorePatternData\": {}";
        case MsgCat::kResolverDebug_RetryingResolutionAfterRemovingTheSuffix: return "Retrying resolution after removing the suffix {}";
        case MsgCat::kResolverDebug_IgnoringEmptyGlobPattern: return "Ignoring empty glob pattern";
        case MsgCat::kResolverDebug_IgnoringGlobImportThatDoesnTStartWithOr: return "Ignoring glob import that doesn't start with \"./\" or \"../\"";
        case MsgCat::kResolverDebug_FailedToFindTheDirectory: return "Failed to find the directory {}";
        case MsgCat::kResolverDebug_ConsideringEntry: return "Considering entry {}";
        case MsgCat::kResolverDebug_CheckingAgainstTheExternalPattern: return "Checking {} against the external pattern {}";
        case MsgCat::kResolverDebug_ResolvedSymlinkTo: return "Resolved symlink {} to {}";
        case MsgCat::kResolverDebug_MarkingThisFileAsHavingNoSideEffectsDueTo: return "Marking this file as having no side effects due to {}";
        case MsgCat::kResolverDebug_ThisImportIsUnderTheEffectOf: return "This import is under the effect of {}";
        case MsgCat::kResolverDebug_JsxFactoryIsDueTo: return "\"jsxFactory\" is {} due to {}";
        case MsgCat::kResolverDebug_JsxFragmentIsDueTo: return "\"jsxFragment\" is {} due to {}";
        case MsgCat::kResolverDebug_PrimaryPathIsInNamespace: return "Primary path is {} in namespace {}";
        case MsgCat::kResolverDebug_SecondaryPathIsInNamespace: return "Secondary path is {} in namespace {}";
        case MsgCat::kResolverDebug_TheImportIsBeingTreatedAsAnAbsolutePath: return "The import {} is being treated as an absolute path";
        case MsgCat::kResolverDebug_FailedToReadDirectory: return "Failed to read directory {}";
        case MsgCat::kResolverDebug_ReadForDirectory: return "Read {} {} for directory {}";
        case MsgCat::kResolverDebug_FailedToReadFile: return "Failed to read file {}: {}";
        case MsgCat::kResolverDebug_TheFileExists: return "The file {} exists";
        case MsgCat::kResolverDebug_TheYarnPnPPathResolutionAlgorithmReturnedAnError: return "The Yarn PnP path resolution algorithm returned an error";
        case MsgCat::kResolverDebug_ParsedTsconfigPackageNameAndPackageSubpath: return "Parsed tsconfig package name {} and package subpath {}";
        case MsgCat::kResolverDebug_LookingForInExportsMapIn: return "Looking for {} in \"exports\" map in {}";
        case MsgCat::kResolverDebug_FailedToReadDirectory2: return "Failed to read directory {}: {}";
        case MsgCat::kResolverDebug_AttemptingToLoadAsAFile: return "Attempting to load {} as a file";
        case MsgCat::kResolverDebug_CheckingForFile: return "Checking for file {}";
        case MsgCat::kResolverDebug_FoundFile: return "Found file {}";
        case MsgCat::kResolverDebug_FailedToFindFile: return "Failed to find file {}";
        case MsgCat::kResolverDebug_AttemptingToLoadAsADirectory: return "Attempting to load {} as a directory";
        case MsgCat::kResolverDebug_FoundMainFieldWithPath: return "Found main field {} with path {}";
        case MsgCat::kResolverDebug_SearchingForMainFieldsIn: return "Searching for main fields in {}";
        case MsgCat::kResolverDebug_DidNotFindMainField: return "Did not find main field {}";
        case MsgCat::kResolverDebug_ResolvedToUsingTheModuleFieldIn: return "Resolved to {} using the \"module\" field in {}";
        case MsgCat::kResolverDebug_TheFallbackPathInCaseOfRequireIs: return "The fallback path in case of \"require\" is {}";
        case MsgCat::kResolverDebug_ResolvedToBecauseOfRequire: return "Resolved to {} because of \"require\"";
        case MsgCat::kResolverDebug_ResolvedToUsingTheFieldIn: return "Resolved to {} using the {} field in {}";
        case MsgCat::kResolverDebug_MatchingAgainstPathsIn: return "Matching {} against \"paths\" in {}";
        case MsgCat::kResolverDebug_UsingAsBaseUrl: return "Using {} as \"baseUrl\"";
        case MsgCat::kResolverDebug_FoundAnExactMatchForInPaths: return "Found an exact match for {} in \"paths\"";
        case MsgCat::kResolverDebug_IgnoringSubstitutionBecauseItEndsInDTs: return "Ignoring substitution {} because it ends in \".d.ts\"";
        case MsgCat::kResolverDebug_FoundAFuzzyMatchForInPaths: return "Found a fuzzy match for {} in \"paths\"";
        case MsgCat::kResolverDebug_MarkingThisPathAsImplicitlyExternalDueToItBeingANodeBuiltIn: return "Marking this path as implicitly external due to it being a node built-in";
        case MsgCat::kResolverDebug_MarkingThisPathAsImplicitlyExternalDueToTheNodePrefix: return "Marking this path as implicitly external due to the \"node:\" prefix";
        case MsgCat::kResolverDebug_RemovingTheNodePrefixBecauseTheTargetEnvironmentDoesnTSupportItWithImportStatements: return "Removing the \"node:\" prefix because the target environment doesn't support it with \"import\" statements";
        case MsgCat::kResolverDebug_RemovingTheNodePrefixBecauseTheTargetEnvironmentDoesnTSupportItWithRequireCalls: return "Removing the \"node:\" prefix because the target environment doesn't support it with \"require\" calls";
        case MsgCat::kResolverDebug_SearchingForInNodeModulesDirectoriesStartingFrom: return "Searching for {} in \"node_modules\" directories starting from {}";
        case MsgCat::kResolverDebug_MarkingThisPathAsExternalBecauseItSAPackagePath: return "Marking this path as external because it's a package path";
        case MsgCat::kResolverDebug_FailedToResolveToAFile: return "Failed to resolve {} to a file";
        case MsgCat::kResolverDebug_ParsedPackageNameAndPackageSubpath: return "Parsed package name {} and package subpath {}";
        case MsgCat::kResolverDebug_CheckingForAPackageInTheDirectory: return "Checking for a package in the directory {}";
        case MsgCat::kResolverDebug_NoBrowserMapFoundInDirectory: return "No \"browser\" map found in directory {}";
        case MsgCat::kResolverDebug_CheckingForInTheBrowserMapIn: return "Checking for {} in the \"browser\" map in {}";
        case MsgCat::kResolverDebug_CheckingFor: return "  Checking for {}";
        case MsgCat::kResolverDebug_FoundMarkedAsDisabled: return "Found {} marked as disabled";
        case MsgCat::kResolverDebug_FoundMappingTo: return "Found {} mapping to {}";
        case MsgCat::kResolverDebug_FailedToFind: return "Failed to find {}";
        case MsgCat::kResolverDebug_LookingForInImportsMapIn: return "Looking for {} in \"imports\" map in {}";
        case MsgCat::kResolverDebug_ThePathMustNotEqual: return "The path {} must not equal \"#\".";
        case MsgCat::kResolverDebug_TheResolvedPathIsExact: return "The resolved path {} is exact";
        case MsgCat::kResolverDebug_ResolvedTo: return "Resolved to {}";
        case MsgCat::kResolverDebug_TheImportIsMissingTheExtension: return "The import {} is missing the extension {}";
        case MsgCat::kResolverDebug_ThePathIsADirectoryWhichIsNotAllowed: return "The path {} is a directory, which is not allowed";
        case MsgCat::kResolverDebug_TheImportIsMissingTheSuffix: return "The import {} is missing the suffix {}";
        case MsgCat::kResolverDebug_TheResolvedPathIsInexact: return "The resolved path {} is inexact";
        case MsgCat::kResolverDebug_ThePathContainsInvalidURLEscapes: return "The path {} contains invalid URL escapes: {}";
        case MsgCat::kResolverDebug_ThePathIsNotAllowedToContain: return "The path {} is not allowed to contain {}";
        case MsgCat::kResolverDebug_ThePathIsNotAllowedToEndWithASlash: return "The path {} is not allowed to end with a slash";
        case MsgCat::kResolverDebug_ThePackageImportIsNotDefined: return "The package import {} is not defined";
        case MsgCat::kResolverDebug_InvalidPackageConfiguration: return "Invalid package configuration";
        case MsgCat::kResolverDebug_UsingTheEntryFor: return "Using the entry for \".\"";
        case MsgCat::kResolverDebug_ThePathIsNotExported: return "The path {} is not exported";
        case MsgCat::kResolverDebug_CheckingObjectPathMapFor: return "Checking object path map for {}";
        case MsgCat::kResolverDebug_FoundExactMatchFor: return "Found exact match for {}";
        case MsgCat::kResolverDebug_TheKeyMatchedWithLeftOver: return "The key {} matched with {} left over";
        case MsgCat::kResolverDebug_TheKeyDidNotMatch: return "The key {} did not match";
        case MsgCat::kResolverDebug_NoKeysMatched: return "No keys matched {}";
        case MsgCat::kResolverDebug_CheckingPathAgainstTarget: return "Checking path {} against target {}";
        case MsgCat::kResolverDebug_CheckingConditionMapForOneOf: return "Checking condition map for one of [{}]";
        case MsgCat::kResolverDebug_TheKeyApplies: return "The key {} applies";
        case MsgCat::kResolverDebug_TheKeyDoesNotApply: return "The key {} does not apply";
        ...
        case MsgCat::kResolverDebug_SubstitutedForInToGet: return "Substituted {} for \"*\" in {} to get {}";
        case MsgCat::kResolverDebug_JoinedToToGet: return "Joined {} to {} to get {}";
        case MsgCat::kResolverDebug_TheTargetIsInvalidBecauseItDoesnTStartWith: return "The target {} is invalid because it doesn't start with \"./\"";
        case MsgCat::kResolverDebug_TheTargetIsInvalidBecauseItContainsInvalidSegment: return "The target {} is invalid because it contains invalid segment {}";
        case MsgCat::kResolverDebug_ThePathIsInvalidBecauseItContainsInvalidSegment: return "The path {} is invalid because it contains invalid segment {}";
        case MsgCat::kResolverDebug_UsingYarnPnPManifestFrom: return "Using Yarn PnP manifest from {}";
        case MsgCat::kResolverDebug_ResolvingIn: return "  Resolving {} in {}";
        case MsgCat::kResolverDebug_FailedToParseSpecifierIntoABareIdentifier: return "  Failed to parse specifier {} into a bare identifier";
        case MsgCat::kResolverDebug_ParsedBareIdentifierAndModulePath: return "  Parsed bare identifier {} and module path {}";
        case MsgCat::kResolverDebug_FoundParentLocator: return "  Found parent locator: [{}, {}]";
        case MsgCat::kResolverDebug_FoundParentPackageAt: return "  Found parent package at {}";
        case MsgCat::kResolverDebug_FailedToFindInPackageDependenciesOfParentPackage: return "  Failed to find {} in \"packageDependencies\" of parent package";
        case MsgCat::kResolverDebug_SearchingForAFallbackBecauseEnableTopLevelFallbackIsTrue: return "  Searching for a fallback because \"enableTopLevelFallback\" is true";
        case MsgCat::kResolverDebug_StoppingBecauseIsInFallbackExclusionList: return "    Stopping because [{}, {}] is in \"fallbackExclusionList\"";
        case MsgCat::kResolverDebug_FoundDependencyLocator: return "  Found dependency locator: [{}, {}]";
        case MsgCat::kResolverDebug_FoundPackageAt: return "  Found package {} at {}";
        case MsgCat::kResolverDebug_ResolvedViaYarnPnPToWithSubpath: return "  Resolved {} via Yarn PnP to {} with subpath {}";
        case MsgCat::kResolverDebug_IgnoringBecauseItMatchesIgnorePatternData: return "  Ignoring {} because it matches \"ignorePatternData\"";
        case MsgCat::kResolverDebug_FoundFallbackForInPackageDependenciesOfTopLevelPackage: return "    Found fallback for {} in \"packageDependencies\" of top-level package: [{}, {}]";
        case MsgCat::kResolverDebug_FoundFallbackForInFallbackPool: return "    Found fallback for {} in \"fallbackPool\": [{}, {}]";
        case MsgCat::kResolverDebug_FailedToFindFallbackForInFallbackPool: return "    Failed to find fallback for {} in \"fallbackPool\"";
        case MsgCat::kResolverDebug_YarnPnPInvariantViolationGETPACKAGEFailedToFindAPackage: return "  Yarn PnP invariant violation: GET_PACKAGE failed to find a package: [{}, {}]";
        case MsgCat::kResolverDebug_ExtractedJSONDataFrom: return "  Extracted JSON data from {}";
